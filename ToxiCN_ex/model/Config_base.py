...
class Config_base(object):
    ...
    def __init__(self, model_name, dataset):
        ...
        self.train_path = path.dirname(path.dirname(__file__))+'/'+ dataset + '/data/train_with_moredata.json'     # 改了
        # self.train_path = path.dirname(path.dirname(__file__))+'/'+ dataset + '/data/train_with_syn.json'     # 改了
        # self.train_path = path.dirname(path.dirname(__file__))+'/'+ dataset + '/data/train_original.json'     # 改了                           # 训练集
        self.dev_path = path.dirname(path.dirname(__file__))+'/'+ dataset + '/data/test.json'                  # 改了                  # 验证集
